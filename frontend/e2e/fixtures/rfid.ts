...
export const BLUFFET = {
  ...
  demoTags: [
    '23657b2d-aa08-5fe8-8553-e9e3affb4678', // tag:12-hour:1
    'bdfd9257-7f51-5012-a9b1-a36617846ce5', // tag:12-hour:2
    'cb60c4cd-8c3e-5bbb-be05-e3f6f34c6313', // tag:12-hour:3
    '5f5ce6ea-49fe-50f3-a456-292a9b7a7739', // tag:12-hour:4
  ] as const,
} as const

export const DEMO_TAG_12H = '23657b2d-aa08-5fe8-8553-e9e3affb4678' // tag:12-hour:1
