...
describe('EventDetails.vue', () => {
  ...
  it('hides Racers and Manual entry ops without PIN', async () => {
    ...
    expect(wrapper.find('[data-testid="event-race-racers"]').exists()).toBe(false)
    expect(wrapper.find('[data-testid="event-race-manual"]').exists()).toBe(false)
  })
  ...
  it('shows Racers and Manual entry ops when PIN unlocked', async () => {
    ...
    expect(wrapper.find('[data-testid="event-race-racers"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="event-race-manual"]').exists()).toBe(true)
  })
