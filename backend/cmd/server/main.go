...
func main() {
	...
	api := router.Group("/api")
	{
		...
		events := api.Group("/events")
		{
			...
			events.GET("/:id/taps", handlers.ListEventTaps)
			events.GET("/:id/participants", handlers.ListEventParticipants)
			events.POST("/:id/taps", append(timerWrite, handlers.CreateEventTap)...)
			events.GET("/:id/bibs", handlers.ListEventBibs)
			events.POST("/:id/bibs/bulk", append(adminOnly, handlers.BulkCreateEventBibs)...)
			events.GET("/:id/bibs/:bibId/tags", handlers.ListBibTags)
			events.POST("/:id/bibs/:bibId/tags", append(adminOnly, handlers.PostBibTag)...)
